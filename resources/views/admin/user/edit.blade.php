                                    ...
                                    <div class="">
                                        <div class="row form-group ">
                                            <div class="col-md-12  well well-sm">
                                                ...
                                                @if ($user->trashed())
                                                    <a href="{{ route('restorepost', [$user->id]) }}" class="btn btn-danger pull-left confirmable"
                                                ...
                                                @else
                                                    ...
                                                    <a href="{{ route('destroypost', [$user->id]) }}" class="btn btn-danger pull-left confirmable"
                                                       data-confirm-title="{{ trans('strings.confirm_title') }}"
