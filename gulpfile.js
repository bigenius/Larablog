...
elixir(function(mix) {
    ...
    mix.scripts(['jquery.min.js','bootstrap.min.js','highlight.min.js','moment.min.js','moment-sv.js','bootstrap-datetimepicker.min.js','lb-admin.js','Sortable.min.js','global.js']);
