...
class TagController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $tag->save();
        return redirect()->route('lb-admin.tag.index')->with(['info' => 'Tag created!', 'status' => 'success' ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $tag->title = $request->title;
        $tag->save();
        return redirect()->route('lb-admin.tag.index')->with(['info' => 'Tag saved!', 'status' => 'success' ]);
    }
